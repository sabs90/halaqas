...
| recurrence_pattern | text | e.g. "every_thursday", "every_friday", "daily_ramadan", "custom" |
| recurrence_days | integer[] | For custom pattern: array of JS getDay() values (0=Sun, 6=Sat). CHECK constraint: values 0–6, non-empty if present |
